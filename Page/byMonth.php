...
<html lang="es">
  ...
  <body id="body">
        <h5 class="form-title">Estado De Cuenta Por Mes</h5>
        <div class="text-center form">
                <form class="row text-center row-form" id="Form" name="Form">
                <input type="text" id="action" class="" name="action" style="display: none;" value="ByMonth"/>
                <div class="col-md-4">
  ...
  <script type="text/javascript" src="../Script/tableMonth.js?1"></script>
